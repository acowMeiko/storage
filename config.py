...
lora_model_path = os.getenv('LORA_MODEL_PATH', "/home/LLaMA-Factory/output/qwen_dpo1_lora")  #LoRA模型路径
MAX_MODEL_LEN = 4096
MEMORY_FILE =os.path.join(Project_ROOT, 'memory', 'memory.json')  #Memory文件路径

DEFAULT_TEMPERATURE = float(os.getenv('DEFAULT_TEMPERATURE', '0.95'))
...
data_levels_file = os.path.join(data_dir, 'dpo_llamafactory', 'dpo_level_level1_llamafactory.json')  #数据级别文件路径
